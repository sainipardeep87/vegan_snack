...
ActiveRecord::Schema.define(version: 20140910120705) do
  ...
  create_table "newsletter_email", force: true do |t|
    t.string "email"
  end
  ...
  create_table "spree_products", force: true do |t|
    ...
    t.datetime "updated_at"
    t.integer  "vendor_id"
    t.string   "nutritional_fact_image_file_name"
    t.string   "nutritional_fact_image_content_type"
    t.integer  "nutritional_fact_image_file_size"
    t.datetime "nutritional_fact_image_updated_at"
    t.text     "ingredients"
  end
  ...
  create_table "subscriptions", force: true do |t|
    ...
    t.string  "subscription_type"
    t.string  "plan_id"
    t.decimal "plan_price",        precision: 8, scale: 2
  end
  ...
  create_table "user_subscriptions", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "updated_to_id",   default: 0
