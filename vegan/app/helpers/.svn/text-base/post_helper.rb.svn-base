...
=end
    def get_list_of_tags_in_edit_form(selected_post)
      ...
      #tag_list = selected_post.tags.collect {|tag| tag.tagname}.join(',')
    end


=begin
    Description: Method will be sending resepective social media sharing links depending on type of media.
